...
def calc(history_data: pd.DataFrame, options: dict = defaultOptions) -> pd.DataFrame:
  ...
  Returns:
      ...
      - 'CDL3BLACKCROWS': 100 (看涨), -100 (看跌), 0 (未识别)
      - 'Signal': 信号 (1: 看涨, -1: 看跌, 0: 中性)
  """
  options = defaultOptions | options
  cdl3blackcrows = talib.CDL3BLACKCROWS(history_data[options['column_open']],
  ...
  result['Signal'] = 0
  result.loc[cdl3blackcrows == 100, 'Signal'] = 1  # Bullish pattern
  result.loc[cdl3blackcrows == -100, 'Signal'] = -1 # Bearish pattern
